...
def fetch_stats(selected_user, df):
    ...
    num_messages = df.shape[0]  #no. of messagess
    
    #fetch number of words
    words = []
    for message in df['message']:  #no. of words
...
def most_occur_texts(selected_user, df):
...
def text_timeline(selected_user, df):
...
def week_activity_map(selected_user, df):
    ...
    timeline = df['day_name'].value_counts()
